...
cases, it is just A[i] because min_or_max(i - 1) * A[i] < A[i]). At each
index i, we collect the minimum and maximum product of subarrays ending
at i, and we use them to inform answers at higher indices. Finally, we
return the maximum subarray product for the whole array.
'''
